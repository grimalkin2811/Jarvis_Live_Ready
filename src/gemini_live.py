...
class GeminiLive:
    ...
    async def connect(self):
        ...
        system_instruction = (
            ...
            "Des routines préconfigurées (réveil, journal du matin, mode travail, pomodoro, pause café, déjeuner, "
            "bilan du soir, mode détente, nuit calme, mode gaming, entretien du PC…) sont déjà enregistrées mais désactivées : "
            "propose-les avec list_routines, active-les ou désactive-les avec update_routine(enabled=true/false) "
            "et lance-les à la demande avec run_routine. "
