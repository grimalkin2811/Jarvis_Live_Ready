...
class GeminiLive:
    ...
    async def connect(self):
        ...
        system_instruction = (
            ...
            "Des routines préconfigurées sont livrées avec Jarvis (bonjour, mode travail, focus, réunion, bonne nuit, réveil…) : "
            "active-les ou désactive-les avec update_routine (« active la routine réveil ») et réinstalle les supprimées "
            "avec restore_preset_routines. Une routine désactivée refuse de s'exécuter : propose simplement de l'activer. "
